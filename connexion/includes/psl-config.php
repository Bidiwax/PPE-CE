...
define("USER", "foxtrop"); 			// The database username. 
define("PASSWORD", "r.i.c.a.r.d.o.2.7.0.1.1.9.9.2."); 	// The database password. 
define("DATABASE", "foxtrop_secure_login");             // The database name.
